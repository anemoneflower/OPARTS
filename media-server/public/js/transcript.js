...
function onUserCondition() {
  ...
  if (userRoomCondition["condition"] == "N") {
    ...
    if (userRoomCondition["topic"] == "College") {       // multitasking game
      ...
      tp = 1;
      speakerTriggers = [
        ["Marco", 17.38, false, false],
        ["Marco", 18.26, true, false],
        ["Bibek", 18.27, false, false],
        ["Bibek", 19.22, true, false],
        ["Marina", 19.22, false, false],
        ["Marina", 19.63, true, false],
        ["Cesar", 19.63, false, false],
        ["Cesar", 20, true, false]
      ];
