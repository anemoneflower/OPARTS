...
def main():
    ...
    inputkey = "4499b593-365b-407d-a143-00533e7bce42_전승민-1"
    keyIdx = 0
    ...
    print(filenames.index('4499b593-365b-407d-a143-00533e7bce42_전승민-1_1629959686269.wav'))
    return
...
#### IGNORE FILES IF RERUN
    ...
    for i, filename in enumerate(filenames):        
      ...
      if filename in ignorenames:
        with open("test2_"+roomID+"_"+user+'.txt', 'a') as f:
