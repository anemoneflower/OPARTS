    ...
    #### Run STT from files
      ...
      for i, filename in enumerate(filenames):        
        ...
        if filename in ignorenames:
          with open("test_"+outputkey+"_"+roomID+"_"+user+'.txt', 'a') as f:
